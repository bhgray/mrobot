 ...
 *
 */
public class <<TEMPLATE>> extends Robot implements RobotWorker {

    /** Creates a new instance of <<TEMPLATE>> */
    public <<TEMPLATE>>(int street, int avenue, Directions.Direction direction, int beepers, java.awt.Color color) {
