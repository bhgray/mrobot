 ...
 *
 */
public class NewRobot1 extends Robot implements RobotWorker {

    /** Creates a new instance of NewRobot1 */
    public NewRobot1(int street, int avenue, Directions.Direction direction, int beepers, java.awt.Color color) {
